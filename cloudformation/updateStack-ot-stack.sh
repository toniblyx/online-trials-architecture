...
aws cloudformation create-change-set --stack-name $STACK_NAME --template-url https://s3.amazonaws.com/$S3_BUCKET/$S3_TEMPLATE_NAME --parameters file://ot-stack-parameters-update.json --change-set-name trial-update --capabilities $CAPABILITIES
